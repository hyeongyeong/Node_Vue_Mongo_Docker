                    ...
                    <div class="modal-body">
                        <slot name="body"> 
                          <div class="grid-format">
                            ...
                            <p>비디오 썸네일 파일 업로드 <img class="modal-img" src="../../assets/icon/plus_img.png" alt="Create Category"> : </p>
                            <div class="filebox">
                              <div id="preview_file">
                            ...
                            <p>비디오 파일 업로드 <img class="modal-img" src="../../assets/icon/plus_video.png" alt="Create Category"> : </p>
                            <div class="filebox">
                              <p id="video_name" />
